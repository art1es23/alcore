...
const pageSliderAbout = (container) => {
    class SliderTemplate {
        ...
        sliderToggle() {
            ...
            console.log(this.sliderListItems.length);
            console.log(this.sliderWrapperWidth);
            console.log(window.getComputedStyle(this.sliderInner).width);

            this.sliderListItems.forEach(item => {
                item.style.width = this.sliderWrapperWidth / (this.sliderListItems.length * 4) + '%';
            });
...
export default pageSliderAbout;
